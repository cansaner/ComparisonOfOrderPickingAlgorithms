...
{
    public class PickListGAPopulation : Population
    {
        #region Constructors
        /// <summary>
        ...
        public PickListGAPopulation(int minSize, int maxSize, IChromosome adamChromosome) : base (minSize, maxSize, adamChromosome)
        {
            if (minSize < 2)
            {
        ...
        public IList<IChromosome> CurrentGenerationChromosomes
        {
            get
            {
                return CurrentGeneration.Chromosomes;
            }
            set
            {
                var f = typeof(Generation).GetField("<Chromosomes>k__BackingField", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.SetField);

                f.SetValue(CurrentGeneration, value);
            }
        }
