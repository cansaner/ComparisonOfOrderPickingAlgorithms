...
namespace ConsoleApplication1
{
    public class Program
    {
        ...
        static int C; //side on the block for the initial item
        static int D; //shelf no of the initial item counted from the upper corridor (0 for Left; 1 for Right)
        ...
        public static void Main(string[] args)
        {
            ...
            Reading("C:\\Users/zehra.duzgit.BILGI/Desktop/sshape.txt"); //GenerateItems(); name of the function can be changed if not read
