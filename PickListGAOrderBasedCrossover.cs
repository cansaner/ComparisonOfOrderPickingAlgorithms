...
namespace ComparisonOfOrderPickingAlgorithms
{
    ...
    /// </remarks>
    /// </summary>
    public class PickListGAOrderBasedCrossover : CrossoverBase //OrderBasedCrossover - OX2
    {
        #region Constructors
        ...
        /// </summary>
        public PickListGAOrderBasedCrossover()
            : base(2, 2)
        {
            IsOrdered = true;
        }
        ...
        {
            //Console.WriteLine("...OX2 Crossover or Position Based Crossover started...");
