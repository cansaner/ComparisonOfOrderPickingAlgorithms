namespace ComparisonOfOrderPickingAlgorithms
{
    ...
    /// </remarks>
    /// </summary>
    public class PickListGAInsertionMutation : PickListGADisplacementMutation
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="PickListGAInsertionMutation"/> class.
        /// </summary>
        public PickListGAInsertionMutation()
        {
            IsOrdered = true;
        }
        #endregion
